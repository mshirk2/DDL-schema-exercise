...
(
  ...
  departure_loc INTEGER REFERENCES cities,
  arrival_loc INTEGER REFERENCES cities,
);
...
INSERT INTO tickets
  (passenger_id, seat, departure_time, arrival_time, airline, departure_loc, arrival_loc)
VALUES
